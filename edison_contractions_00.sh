...
#SBATCH -e edison_contract_pi.err
#SBATCH -o edison_contract_pi.out
...
configlist_name='/global/homes/s/srijitp/spaul/projects/pi_nucleon/configlist.temp'
